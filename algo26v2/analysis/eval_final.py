...
import numpy as np
import pandas as pd
import sys,os; sys.path.insert(0,os.path.dirname(__file__)); from final_strategy import getMyPosition as getPosition

nInst = 0
nt = 0

pricesFile = os.path.join(os.path.dirname(__file__),"..","prices.txt")
numTestDays = 250
