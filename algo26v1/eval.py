...
import numpy as np
import pandas as pd
from Arbitrage_Victims import getMyPosition as getPosition

nInst = 0
nt = 0

pricesFile = "./prices.txt"
numTestDays = 440   # full-window walk-forward: days 60-500 (the model warms up over the first 60 days,
                    # and day 0 has no price history to trade on, so 500 is not a valid startDay).
