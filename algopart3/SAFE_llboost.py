"""
================================================================================
###  SAFE_llboost.py  ·  SAFE_llvol idio book + significance-gated pairwise   ###
###                      boost (min-history gated)  ·  SELF-CONTAINED FILE   ###
================================================================================
...
BOOST_N_CANDIDATES = 49   # candidate leaders per follower (Bonferroni divisor)
