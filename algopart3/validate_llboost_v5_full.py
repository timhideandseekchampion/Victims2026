"""Final validation: run the ACTUAL SAFE_llboost_v5.getMyPosition (production module) through the
...
import SAFE_llboost_v5 as CANDIDATE
...
print("building SAFE_llboost_v5 positions (candidate) ...")
t0 = time.time()
...
report("SAFE_llboost_v5 (new)", POS_cand, base_scs)

print("\nsanity: NEW here should match eval_llboost_v2.py's official score exactly (839.13)")
