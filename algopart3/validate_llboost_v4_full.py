"""Final validation: run the ACTUAL SAFE_llboost_v4.getMyPosition (production module) through the
...
import SAFE_llboost_v4 as CANDIDATE
...
print("building SAFE_llboost_v4 positions (candidate) ...")
t0 = time.time()
...
report("SAFE_llboost_v4 (new)", POS_cand, base_scs)

print("\nsanity: NEW here should match eval_llboost_v2.py's official score exactly (867.52)")
