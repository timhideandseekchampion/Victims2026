...
================================================================================
"""
# Internal reference (not part of the submission's public docstring above): this build corresponds
# to SAFE_llboost_v22.py / SUBMISSION_v2.py in this same directory -- the best-validated candidate
# as of 2026-07-30, having beaten every other tested variant (v15, v19, v21 individually, and every
# later candidate: v28 ridge-weight, resid diversifier, E66, four deadband variants, vol-scaled
# sizing, learned BOOST_K, ROT_W re-sweep, second-lag boost, blended fallback selection).
import numpy as np
