"""
Algothon 2026 — Arbitrage Victims, PART-2 book (tuned on the days 400-750 hunt).
...
# ------------------------------------------------------------------ knobs (search winner)
HALF_LIFE   = 500       # EWLS forgetting half-life for the lead-lag ridge
RIDGE_A     = 0.1       # L2 on the 51->50 coefficient matrix
BLEND       = 0.30      # weight on cross-sectional reversion mixed into the forecast
...
HEDGE       = True      # residual beta-hedge with ALGO, applied last
